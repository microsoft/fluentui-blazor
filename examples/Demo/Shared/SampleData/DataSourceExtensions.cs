...
public static class DataSourceExtensions
{
    ...
    {
        var longName = new Person(PersonId: 91, FirstName: "Jean", LastName: "With a very long name to validate components", CountryCode: "fr", BirthDate: new DateOnly(1984, 4, 27));
