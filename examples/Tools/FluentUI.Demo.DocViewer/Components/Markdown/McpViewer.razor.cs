...
/// <summary>
/// Component to display MCP (Model Context Protocol) documentation in detailed view.
/// </summary>
public partial class McpViewer
{
    /// <summary>
    ...
    {
        if (!firstRender && IsDocumentationLoaded)
        {
            LoadData();
        }
    }
    ...
    /// <summary>
    /// Loads the MCP data based on the current type and filter.
    /// </summary>
