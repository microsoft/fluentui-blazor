...
public static class ReflectionExtensions
{
        ...
        bool invokeTypeNameConverterForGenericType = false)
    {
        ...
        {
            var transformNames = parameterInfo.GetCustomAttribute<TupleElementNamesAttribute>()?.TransformNames;
            var nameStringWithValueTupleNames = parameterInfo.ParameterType.GetElementType()?.ToNameStringWithValueTupleNames(transformNames, typeNameConverter, invokeTypeNameConverterForGenericType);

            return (parameterInfo.IsIn ? "in " : (parameterInfo.IsOut ? "out " : "ref ")) + nameStringWithValueTupleNames;
        }
    ...
    /// </summary>
    /// <param _name="genericTypeName">Type name</param>
    ...
    /// <summary>
    /// Returns the enum values for the specified property.
    /// </summary>
    /// <param name="propertyInfo"></param>
    /// <returns></returns>
    public static string[] GetEnumValues(this PropertyInfo? propertyInfo)
    {
