...
/// <summary>
/// Marker interface for components that can be direct children of <see cref="FluentNavDrawer"/>.
/// </summary>
/// <remarks>
/// Implement this interface to indicate that a component is allowed to be rendered as a direct child
/// of <see cref="FluentNavDrawer"/>. Only components implementing this interface should be used as children
