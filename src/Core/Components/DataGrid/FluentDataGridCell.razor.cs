...
public partial class FluentDataGridCell<TGridItem> : FluentComponentBase
{
    ...
    protected string? StyleValue => DefaultStyleBuilder
        ...
        .AddStyle("inset-inline-start", $"{Column!.PinOffset.ToString(CultureInfo.InvariantCulture)}px", Column != null && Column.Pin == DataGridColumnPin.Start)
        .AddStyle("inset-inline-end", $"{Column!.PinOffset.ToString(CultureInfo.InvariantCulture)}px", Column != null && Column.Pin == DataGridColumnPin.End)
