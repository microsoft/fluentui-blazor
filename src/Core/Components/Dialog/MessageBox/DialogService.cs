...
public partial class DialogService : IDialogService
{
    ...
    public Task<DialogResult> ShowSuccessAsync(string message, string? title = null, string? primaryAction = null)
    {
        return ShowMessageBoxAsync(new MessageBoxOptions
        {
            Title = title ?? "Success",
            Message = message,
            PrimaryAction = primaryAction ?? "OK",
    ...
    public Task<DialogResult> ShowWarningAsync(string message, string? title = null, string? primaryAction = null)
    {
        return ShowMessageBoxAsync(new MessageBoxOptions
        {
            Title = title ?? "Warning",
    ...
    public Task<DialogResult> ShowErrorAsync(string message, string? title = null, string? primaryAction = null)
    {
        return ShowMessageBoxAsync(new MessageBoxOptions
        {
            Title = title ?? "Error",
    ...
    public Task<DialogResult> ShowInfoAsync(string message, string? title = null, string? primaryAction = null)
    {
        return ShowMessageBoxAsync(new MessageBoxOptions
        {
    ...
    public Task<DialogResult> ShowConfirmationAsync(string message, string? title = null, string? primaryAction = null, string? secondaryAction = null)
    {
        return ShowMessageBoxAsync(new MessageBoxOptions
        {
            ...
            SecondaryAction = secondaryAction ?? "No",
    ...
    public async Task<DialogResult> ShowMessageBoxAsync(MessageBoxOptions options)
    {
        var dialog = await ShowDialogAsync<FluentMessageBox>(config =>
        {
            ...
            config.Footer.PrimaryAction.Label = options.PrimaryAction;
            config.Footer.SecondaryAction.Label = options.SecondaryAction;
