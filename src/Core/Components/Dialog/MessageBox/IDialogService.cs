...
public partial interface IDialogService
{
    ...
    /// <param name="primaryAction">Text to display in the primary action button.</param>
    /// <returns>Result of the dialog. Always `Cancelled = false`.</returns>
    Task<DialogResult> ShowSuccessAsync(string message, string? title = null, string? primaryAction = null);
    ...
    /// <returns>Result of the dialog. Always `Cancelled = false`.</returns>
    Task<DialogResult> ShowWarningAsync(string message, string? title = null, string? primaryAction = null);
    ...
    /// <param name="primaryAction">Text to display in the primary action button. Default is "OK".</param>
    /// <returns>Result of the dialog. Always `Cancelled = false`.</returns>
    Task<DialogResult> ShowErrorAsync(string message, string? title = null, string? primaryAction = null);
    ...
    /// <param name="primaryAction">Text to display in the primary action button.  Default is "Yes".</param>
    /// <param name="secondaryAction">Text to display in the secondary action button.  Default is "No".</param>
    /// <returns>Result of the dialog: Yes returns `Cancelled = false`, No returns `Cancelled = true`</returns>
    Task<DialogResult> ShowConfirmationAsync(string message, string? title = null, string? primaryAction = null, string? secondaryAction = null);
