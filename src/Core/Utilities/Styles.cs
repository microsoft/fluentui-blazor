...
public class Styles
{
    ...
    public partial class Zs
    {
        ...
        {
            /// <summary />
            public const string Background = "var(--zIndexBackground)";

            /// <summary />
            public const string Content = "var(--zIndexContent)";

            /// <summary />
            public const string Debug = "var(--zIndexDebug)";

            /// <summary />
            public const string Floating = "var(--zIndexFloating)";

            /// <summary />
            public const string Messages = "var(--zIndexMessages)";

            /// <summary />
            public const string Overlay = "var(--zIndexOverlay)";

            /// <summary />
            public const string Popup = "var(--zIndexPopup)";

            /// <summary />
            public const string Priority = "var(--zIndexPriority)";
