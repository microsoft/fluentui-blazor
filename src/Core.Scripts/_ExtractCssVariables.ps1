...
#    5. Copy the output to the `StylesVariables.cs` file in the `Microsoft.FluentUI.AspNetCore.Components` project.
# ************************************************************
...
Write-Output "//     This code was generated by a tool."
Write-Output "//"
Write-Output "//     Changes to this file may cause incorrect behavior and will be lost if"
