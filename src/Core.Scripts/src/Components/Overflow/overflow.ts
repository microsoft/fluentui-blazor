...
import { OverflowController } from './overflow-controller.js';
import type { OverflowDirection, OverflowOrientation, OverflowToggleDetail } from './overflow.types.js';
...
declare global {
  ...
  interface HTMLElementEventMap {
    overflowchange: CustomEvent<import('./overflow.types.js').OverflowChangeDetail>;
    fluentoverflowchange: CustomEvent<import('./overflow.types.js').OverflowChangeDetail>;
    fluentoverflowtoggle: CustomEvent<OverflowToggleDetail>;
  }
}
