...
import { Microsoft as SmartTextAreaFile } from './SmartTextArea';
...
export namespace Microsoft.FluentUI.Blazor.Components.SmartTextArea {
  ...
  import SmartTextArea = SmartTextAreaFile.FluentUI.Blazor.Components.SmartTextArea.SmartTextArea;
  ...
  export class OverlaySuggestionDisplay implements SuggestionDisplay {
    ...
    show(suggestion: string): void {
      ...
      const caretOffset = CaretUtil.getCaretOffsetFromOffsetParent(this.textArea);
    ...
    accept(): void {
      ...
      CaretUtil.insertTextAtCaretPosition(this.textArea, this.currentSuggestion);
