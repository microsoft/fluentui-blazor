...
export function stackedBarChartTemplate<T extends StackedBarChart>(): ElementViewTemplate<T> {
  return html<T>`
    <template>
...
export const template: ElementViewTemplate<StackedBarChart> = stackedBarChartTemplate();
