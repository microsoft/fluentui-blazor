...
export const rebalanceSimpleData: SankeyChartData = {
  nodes: [
    { name: 'Large Source', color: 'qualitative.11' },
    { name: 'Tiny Source', color: 'qualitative.12' },
    { name: 'Large Target', color: 'qualitative.13' },
    { name: 'Tiny Target', color: 'qualitative.14' },
  ],
  links: [
...
export const rebalanceComplexData: SankeyChartData = {
  nodes: [
    { name: 'Location 1' },
    { name: 'Location 2' },
    { name: 'Location 3' },
    ...
    { name: 'Application 14' },
    { name: 'Conditional access not applied' },
