...
## Blazor Hybrid
Starting with the 2.0 release, you can also use this library in your Blazor Hybrid projects. Setup is the same as described in the "Getting started" section above, but to get the FluentIcons to work you'll need to take two extra steps:
