...
> **note**: An options argument can be added to `AddFluentUIComponents`. The `options.HostingModel` parameter is used to determine the type of project you're building. Choose the appropriate value from the `BlazorHostingModel` enumeration.
